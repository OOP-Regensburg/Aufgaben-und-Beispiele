...
public class TrafficLight {
	...
	private void initTrafficLightFrame(int canvasWidth) {
		frame = new Compound();
		Rect upperFrame = new Rect(canvasWidth / 2 - 120, 50, 240, 380,
				TRAFFIC_LIGHT_BACKGROUND);
		Rect lowerFrame = new Rect(canvasWidth / 2 - 30, 50, 60, 480,
				TRAFFIC_LIGHT_BACKGROUND);
	...
	private void initTrafficLight(int canvasWidth) {
		...
		yellowLight = new Ellipse(canvasWidth / 2, 120, TRAFFIC_LIGHT_DIAM,
				TRAFFIC_LIGHT_DIAM, TRAFFIC_LIGHT_DEFAULT);
		greenLight = new Ellipse(canvasWidth / 2, 120, TRAFFIC_LIGHT_DIAM,
				TRAFFIC_LIGHT_DIAM, TRAFFIC_LIGHT_DEFAULT);
	}
